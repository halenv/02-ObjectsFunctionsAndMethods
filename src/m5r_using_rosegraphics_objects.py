...
#                  get_bounding_box(), move_by(), move_center_to()
#
#          -- Write the names of three INSTANCE VARIABLEs
#             that Circle objects have:
#                radius, center, defaults
#
#     f. What does a RoseWindow RENDER method do?
#            makes the shapes/ points show up with the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It is necessary at the very end of a function is a widow is to be opened.
#            The window will stay open and the next window will open if it is not there.
#
...
def example1():
    ...
    window3 = rg.RoseWindow(400,300)
    window3.close_on_mouse_click() #basicall if window2 = window3, then 400, 300 are the correct dimensions
