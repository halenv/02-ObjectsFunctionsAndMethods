...
def turtle4():
    ...
    dama = rg.SimpleTurtle()
    dama.speed = 8

    dama.pen = rg.Pen('lavender', 25)
    dama.paint_bucket = rg.PaintBucket('light sea green')
...
def turtle5():
    ...
    jojo.speed = 4
    jojo.pen = rg.Pen('olive drab', 12)

    navy = rg.SimpleTurtle()
    navy.speed = 10
    navy.pen = rg.Pen('navy blue',3)

    jojo.right(180)
    jojo.forward(200)

    jojo.draw_regular_polygon(7,70)
    navy.draw_regular_polygon(5,42)
...
#            (Answer: look at the LAST line of this module, far below.) main
#
